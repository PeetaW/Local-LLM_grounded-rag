...
class AnswerVerifier:
    ...
    def _extract_reasoning_sections(draft_answer: str) -> str:
        ...
        """
        import re
        # 匹配 ## 開頭、包含「推論」或「延伸」或「推測」的段落直到下一個 ## 或結尾
        pattern = r'(##[^\n]*(?:推論|延伸|推測)[^\n]*\n[\s\S]*?)(?=\n##|\Z)'
