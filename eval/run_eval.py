...
def _write_debug_artifacts(label: str, qid: str, question: str, artifacts: dict, status_lines: list, row: dict):
    ...
    items = {
        ...
        "stage3_initial_knowledge_base": artifacts.get("stage3_initial_knowledge_base"),
        "stage3_prompt": artifacts.get("stage3_prompt"),
        "stage3_generation_meta": artifacts.get("stage3_generation_meta"),
        "stage3_raw_output": artifacts.get("stage3_raw_output"),
        "stage3_fact_contract": artifacts.get("stage3_fact_contract"),
        "stage3_plain_prompt": artifacts.get("stage3_plain_prompt"),
        "stage3_plain_output": artifacts.get("stage3_plain_output"),
        "stage3_literal_facts": artifacts.get("stage3_literal_facts"),
        "stage3_recovery_prompt": artifacts.get("stage3_recovery_prompt"),
        "stage3_recovery_generation_meta": artifacts.get("stage3_recovery_generation_meta"),
        "stage3_recovery_raw_output": artifacts.get("stage3_recovery_raw_output"),
        "stage3_recovery_fact_contract": artifacts.get("stage3_recovery_fact_contract"),
        "stage3_recovery_literal_facts": artifacts.get("stage3_recovery_literal_facts"),
        "stage3_recovery_knowledge_base": artifacts.get("stage3_recovery_knowledge_base"),
        "partial_recovery_assessment": artifacts.get("partial_recovery_assessment"),
        ...
        "stage4_fact_contract": artifacts.get("stage4_fact_contract"),
        "stage4_grounding_claims": artifacts.get("stage4_grounding_claims"),
